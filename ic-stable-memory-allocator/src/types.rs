...
/**
This allocator uses segregated explicit free list to track free memory blocks. There are total 28
segregation classes, each taking a u64 of space (28 * 8 = 224 bytes).
...
pub const MAX_SEGREGATION_CLASSES: usize = 28;
